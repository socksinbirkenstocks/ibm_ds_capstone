...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        site_total = len(data)  # Total launches for the selected site
        success_count = data['class'].sum()  # Count of successful launches
        
        # Prepare values for pie chart
        values = [success_count, site_total - success_count]
